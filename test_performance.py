...
def run_tests(depth):
    ...
    test_from_position(fen, ["g1f3"], depth=depth)
    ...
    test_from_position(fen, depth=depth)
    ...
    test_from_position(fen, ["e2e4"], depth=depth)
    ...
    test_from_position(fen, ["c4f7"], depth=depth)
    ...
    test_from_position(fen, ["f6h8"], depth=depth)
...
def run_realistic_tests(depth):
    ...
    test_from_position(fen, ["e7e5"], depth=depth)
    ...
    test_from_position(fen, ["f6e4"], depth=depth)
    ...
    test_from_position(fen, ["f3e5"], depth=depth)
    ...
    test_from_position(fen, ["e7e6"], depth=depth)
...
for depth in range(1, 5):
    print(f"\n=== Running tests with depth {depth} ===")
    run_tests(depth)
    run_realistic_tests(depth)
print("\n=== All Tests Completed ===")
